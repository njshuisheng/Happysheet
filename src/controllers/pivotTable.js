...
const pivotTable = {
    ...
    if (Store.luckysheetfile[realIndex].pivotTable != null) {
      ...
      if (Store.luckysheetfile[realIndex].pivotTable.drawPivotTable != null) {
        _this.drawPivotTable =
          Store.luckysheetfile[realIndex].pivotTable.drawPivotTable;
      } else {
        _this.drawPivotTable = true;
      }

      if (
        Store.luckysheetfile[realIndex].pivotTable.pivotTableBoundary != null
      ) {
        _this.pivotTableBoundary =
          Store.luckysheetfile[realIndex].pivotTable.pivotTableBoundary;
      } else {
      ...
      if (data_select_save != null) {
        ...
        _this.pivot_select_save =
          Store.luckysheetfile[realIndex].pivotTable.pivot_select_save;
      }
      ...
      if (datasheetindex != null) {
        ...
        _this.pivotDataSheetIndex =
          Store.luckysheetfile[realIndex].pivotTable.pivotDataSheetIndex;
      }
    } else {
      _this.column = null;
      _this.row = null;
  ...
  showvaluecolrow: function () {
    ...
    if (
      $(
        "#luckysheet-modal-dialog-config-value .luckysheet-modal-dialog-slider-config-item"
      ).length >= 2
    ) {
  ...
  luckysheetsliderlistclearfilter: function ($filter) {
    ...
    $(
      "#luckysheet-pivotTableFilter-menu, #luckysheet-pivotTableFilter-submenu"
    ).hide();
  },
  luckysheetsliderlistitemfilter: function ($filter) {
    ...
    if (byconditiontype == "2") {
      let $input = $(
        "#luckysheet-pivotTableFilter-menu .luckysheet-pivotTableFilter-selected-input2"
      )
        .show()
        .find("input");
  ...
  changePivotTable: function (index) {
    ...
    let pivotDataSheetIndex =
      Store.luckysheetfile[getSheetIndex(index)].pivotTable.pivotDataSheetIndex;
  ...
  storePivotTableParam: function () {
    ...
    $(
      "#luckysheet-modal-dialog-config-filter .luckysheet-modal-dialog-slider-config-item"
    ).each(function () {
      let item = {};
    ...
    $(
      "#luckysheet-modal-dialog-config-row .luckysheet-modal-dialog-slider-config-item"
    ).each(function () {
      let item = {};
      item["index"] = $(this).data("index");
      item["name"] = $(this).data("name");
    ...
    $(
      "#luckysheet-modal-dialog-config-column .luckysheet-modal-dialog-slider-config-item"
    ).each(function () {
      let item = {};
      item["index"] = $(this).data("index");
      item["name"] = $(this).data("name");
    ...
    let showtype = $(
      "#luckysheetpivottablevaluecolrow:checked, #luckysheetpivottablevaluecolrow1:checked"
    ).val();
  ...
  initialPivotManage: function (restore) {
    ...
    if (_this.initial) {
      ...
      $(document)
        ...
        .on(
          ...
          "#luckysheet-pivotTableFilter-byvalue-select .textBox",
          function () {
      ...
      $(document)
        ...
        .on(
          ...
          "#luckysheet-pivotTableFilter-byvalue-select .year",
          function () {
            if ($(this).attr("data-check") == "true") {
              $(this).attr("data-check", "false");
              $(this)
      ...
      $(document)
        ...
        .on(
          ...
          "#luckysheet-pivotTableFilter-byvalue-select .month",
          function () {
            //月份 对应的 天
            if ($(this).attr("data-check") == "true") {
              $(this).attr("data-check", "false");
      ...
      $(document)
        ...
        .on(
          ...
          "#luckysheet-pivotTableFilter-byvalue-select .day",
          function () {
            if ($(this).attr("data-check") == "true") {
              $(this).attr("data-check", "false");
              $(this).find("input[type='checkbox']").removeAttr("checked");
      ...
      $("#luckysheet-pivotTableFilter-byvalue-btn-contra").click(function () {
        ...
        //天 对应的 月份
        let $month = $(
          "#luckysheet-pivotTableFilter-byvalue-select .ListBox .monthBox"
        );
        ...
        //天 对应的 年份
        let $year = $(
          "#luckysheet-pivotTableFilter-byvalue-select .ListBox .yearBox"
        );
      ...
      //按照值进行筛选
      $("#luckysheet-pivotTableFilter-byvalue-input").on(
        "input propertychange",
        function () {
          let v = $(this).val().toString();
          $(
            "#luckysheet-pivotTableFilter-byvalue-select .ListBox .luckysheet-mousedown-cancel"
          ).show();
          if (v != "") {
            let $check = $(
              "#luckysheet-pivotTableFilter-byvalue-select .ListBox input[type='checkbox']"
      ...
      $(
        "#luckysheet-pivotTableFilter-bycondition, #luckysheet-pivotTableFilter-byvalue"
      ).click(function () {
        let $t = $(this);
        ...
        setTimeout(function () {
          if (
            ...
            $("#luckysheet-pivotTableFilter-bycondition").next().is(":visible")
          ) {
            if (
              $("#luckysheet-pivotTableFilter-selected span").text() !=
          ...
          if ($t.is($("#luckysheet-pivotTableFilter-bycondition"))) {
            if (
              $("#luckysheet-pivotTableFilter-bycondition")
                .next()
                .is(":hidden") &&
              $("#luckysheet-pivotTableFilter-byvalue").next().is(":hidden")
            ) {
      ...
      $("#luckysheet-modal-dialog-pivotTable-list").on(
        "click",
        " .luckysheet-slider-list-item-filter",
        function (e) {
      ...
      $("#luckysheet-dialog-pivotTable-range-seleted").click(function () {
        ...
        _this.jgridCurrentPivotInput = $(
          "#luckysheet-dialog-pivotTable-range"
        ).html();
      ...
      $("#luckysheet-pivotTableFilter-initial").click(function () {
        $(
          "#luckysheet-modal-dialog-pivotTable-list .luckysheet-slider-list-item-filtered"
        ).hide();
        $(
          "#luckysheet-modal-dialog-pivotTable-list .luckysheet-modal-dialog-slider-list-item"
        ).data("rowhidden", "");
          ...
          .each(function () {
            if ($(this).data("index") == cindex) {
              $(this).data(
                $t
                  .attr("id")
                  .replace("luckysheet-pivotTable-config-option-", ""),
                $t.val()
              );
            }
          });
      ...
      $("#luckysheet-modal-dialog-config-value").on(
        ...
        function (e) {
          ...
          $menu
            .find(
              ".luckysheet-cols-menuitem[sumtype='" +
                sumtype +
      ...
      $(
        ...
        let $item = $("#luckysheet-pivotTable-config-option-sumtype").data(
          "item"
        );
      ...
      $("#luckysheet-modal-dialog-config-filter").on(
        ...
        function (e) {
          let $t = $(e.target),
            cindex = $t
              .closest(".luckysheet-modal-dialog-slider-config-item")
              .data("index");
      ...
      $("#luckysheet-pivotTableFilter-confirm").click(function () {
        ...
        if (
          $("#luckysheet-pivotTableFilter-bycondition").next().is(":visible") &&
          $("#luckysheet-pivotTableFilter-byvalue").next().is(":hidden") &&
          $("#luckysheet-pivotTableFilter-selected span").data("value") !=
            "null"
        ) {
      ...
      $(
        ...
        luckysheetsizeauto();
        $(
          "#luckysheet-cell-main .luckysheet-pivotTable-selection-set div"
        ).show();
      ...
      $("#luckysheet-pivotTable-selection-confirm").click(function () {
        ...
        if (
          ...
          $(
            "#luckysheet-data-pivotTable-selection .luckysheet-model-close-btn"
          ).click();
          return;
        } else {
          let val1 = val.split("!");
      ...
      $(
        ...
        .mousemove(function (e) {
          if (_this.movestate) {
            ...
            if (row_index == -1) {
              $("#luckysheet-modal-dialog-config-order-help").css({
        ...
        .mouseup(function (e) {
          if (_this.movestate) {
            ...
            if (row_index == -1) {
              if (
                $t.find(".luckysheet-modal-dialog-slider-config-item").length ==
                0
              ) {
                $t.append(itemHTML);
              } else {
    ...
    $("#luckysheet-dialog-pivotTable-range").html(
