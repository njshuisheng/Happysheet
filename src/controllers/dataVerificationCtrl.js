...
const dataVerificationCtrl = {
  ...
  createDialog: function () {
    ...
    let $t = $("#luckysheet-dataVerification-dialog")
  ...
  init: function () {
    ...
    $(document)
      .off("click.dvRange")
      .on("click.dvRange", "#data-verification-range .fa-table", function (e) {
    ...
    $(document)
      ...
      .on(
        "click.dvRange2",
        "#luckysheet-dataVerification-dialog .show-box-item-dropdown .range .fa-table",
        function (e) {
          $("#luckysheet-dataVerification-dialog").hide();
    ...
    $(document)
      .off("click.dvRangeConfirm")
      .on(
        "click.dvRangeConfirm",
        ...
        function (e) {
          ...
          if (dataSource == "0") {
            $(
              "#luckysheet-dataVerification-dialog #data-verification-range input"
            ).val(txt);
          } else if (dataSource == "1") {
            $(
              "#luckysheet-dataVerification-dialog .show-box-item-dropdown .range input"
            ).val(txt);
          }
    ...
    $(document)
      ...
      .on("change.typeSelect", "#data-verification-type-select", function (e) {
        $(
        ...
        if (value == "dropdown") {
          $(
            "#luckysheet-dataVerification-dialog .show-box .show-box-item-dropdown"
          ).show();
          ...
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-dropdown .data-verification-value1"
          ).val(value1);

          $(
            "#luckysheet-dataVerification-dialog #data-verification-multi"
          ).prop("checked", item.type2 ? true : false);
        } else if (value == "checkbox") {
          $(
            "#luckysheet-dataVerification-dialog .show-box .show-box-item-checkbox"
          ).show();
          ...
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-checkbox .data-verification-value1"
          ).val(value1);
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-checkbox .data-verification-value2"
          ).val(value2);
        } else if (
          value == "number" ||
          ...
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-number .input"
          ).hide();
          ...
          $(
            "#luckysheet-dataVerification-dialog #data-verification-number-select"
          ).val(type2);

          if (type2 == "bw" || type2 == "nb") {
            $(
              "#luckysheet-dataVerification-dialog .show-box-item-number .input1"
            ).show();
          } else {
            $(
              "#luckysheet-dataVerification-dialog .show-box-item-number .input2"
            ).show();
          }

          $(
            "#luckysheet-dataVerification-dialog .show-box-item-number .data-verification-value1"
          ).val(value1);
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-number .data-verification-value2"
          ).val(value2);
          ...
          $(
            "#luckysheet-dataVerification-dialog #data-verification-text-select"
          ).val(type2);
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-text .data-verification-value1"
          ).val(value1);
        } else if (value == "text_length") {
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-textLength"
          ).show();
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-textLength .input"
          ).hide();
          ...
          $(
            "#luckysheet-dataVerification-dialog #data-verification-textLength-select"
          ).val(type2);

          if (type2 == "bw" || type2 == "nb") {
            $(
              "#luckysheet-dataVerification-dialog .show-box-item-textLength .input1"
            ).show();
          } else {
            $(
          ...
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-textLength .data-verification-value1"
          ).val(value1);
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-textLength .data-verification-value2"
          ).val(value2);
        } else if (value == "date") {
          $("#luckysheet-dataVerification-dialog .show-box-item-date").show();
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-date .input"
          ).hide();
          ...
          $(
            "#luckysheet-dataVerification-dialog #data-verification-date-select"
          ).val(type2);

          if (type2 == "bw" || type2 == "nb") {
            $(
              "#luckysheet-dataVerification-dialog .show-box-item-date .input1"
            ).show();
          } else {
            $(
              "#luckysheet-dataVerification-dialog .show-box-item-date .input2"
            ).show();
          }

          $(
            "#luckysheet-dataVerification-dialog .show-box-item-date .data-verification-value1"
          ).val(value1);
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-date .data-verification-value2"
          ).val(value2);
        } else if (value == "validity") {
          $(
            "#luckysheet-dataVerification-dialog .show-box .show-box-item-validity"
          ).show();
          ...
          $(
            "#luckysheet-dataVerification-dialog #data-verification-validity-select"
          ).val(type2);
        }
      });

    $(document)
      .off("change.numberSelect")
      .on(
        "change.numberSelect",
        "#data-verification-number-select",
        function (e) {
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-number .input"
          ).hide();
    ...
    // 文本长度选择变化
    $(document)
      .off("change.textLengthSelect")
      .on(
        "change.textLengthSelect",
        "#data-verification-textLength-select",
        function (e) {
          $(
            "#luckysheet-dataVerification-dialog .show-box-item-textLength .input"
          ).hide();
    ...
    $(document)
      ...
      .on("change.dateSelect", "#data-verification-date-select", function (e) {
        $(
          "#luckysheet-dataVerification-dialog .show-box-item-date .input"
        ).hide();
    ...
    $(document)
      .off("change.hintShow")
      .on("change.hintShow", "#data-verification-hint-show", function (e) {
        if (this.checked) {
          $(
    ...
    //确认按钮
    $(document)
      .off("click.dvSaveConfirm")
      .on(
        "click.dvSaveConfirm",
        "#luckysheet-dataVerification-dialog-confirm",
        function (e) {
          let rangeTxt = $(
            "#luckysheet-dataVerification-dialog #data-verification-range input"
          )
          ...
          let type = $(
            "#luckysheet-dataVerification-dialog #data-verification-type-select"
          ).val();
          let type2 = null,
            value1 = "",
            value2 = "";
          ...
          if (type == "dropdown") {
            ...
            value1 = $(
              "#luckysheet-dataVerification-dialog .show-box-item-number .input:visible .data-verification-value1"
            )
              .val()
              .trim();
            ...
            if (type2 == "bw" || type2 == "nb") {
              value2 = $(
                "#luckysheet-dataVerification-dialog .show-box-item-number .input:visible .data-verification-value2"
              )
                .val()
                .trim();
            ...
            value1 = $(
              "#luckysheet-dataVerification-dialog .show-box-item-textLength .input:visible .data-verification-value1"
            )
              .val()
              .trim();
            ...
            if (type2 == "bw" || type2 == "nb") {
              value2 = $(
                "#luckysheet-dataVerification-dialog .show-box-item-textLength .input:visible .data-verification-value2"
              )
                .val()
                .trim();
            ...
            value1 = $(
              "#luckysheet-dataVerification-dialog .show-box-item-date .input:visible .data-verification-value1"
            )
              .val()
              .trim();
            ...
            if (type2 == "bw" || type2 == "nb") {
              value2 = $(
                "#luckysheet-dataVerification-dialog .show-box-item-date .input:visible .data-verification-value2"
              )
                .val()
                .trim();
          ...
          let remote = $(
            "#luckysheet-dataVerification-dialog #data-verification-remote"
          ).is(":checked");
          let prohibitInput = $(
            "#luckysheet-dataVerification-dialog #data-verification-prohibitInput"
          ).is(":checked");
          let hintShow = $(
            "#luckysheet-dataVerification-dialog #data-verification-hint-show"
          ).is(":checked");
          let hintText = "";
    ...
    $(document)
      ...
      .on(
        "click.delete",
        "#luckysheet-dataVerification-dialog-delete",
        function (e) {
          let rangeTxt = $(
            "#luckysheet-dataVerification-dialog #data-verification-range input"
          )
    ...
    $(document).on(
      "click",
      "#luckysheet-info .luckysheet-modal-dialog-title-close, #luckysheet-info .luckysheet-model-close-btn",
      function (e) {
  ...
  dataAllocation: function () {
    ...
    $("#luckysheet-dataVerification-dialog #data-verification-range input").val(
      rangeTxt
    );
    ...
    //验证条件
    $("#luckysheet-dataVerification-dialog #data-verification-type-select").val(
      item.type
    );
    ...
    if (item.type == "dropdown") {
      ...
      $("#luckysheet-dataVerification-dialog #data-verification-multi").prop(
        "checked",
        item.type2 ? true : false
      );
    ...
    //自动远程获取选项
    $("#luckysheet-dataVerification-dialog #data-verification-remote").prop(
      "checked",
      item.remote
    );
    ...
    $(
      "#luckysheet-dataVerification-dialog #data-verification-prohibitInput"
    ).prop("checked", item.prohibitInput);

    //选中单元格时显示提示语
    $("#luckysheet-dataVerification-dialog #data-verification-hint-show").prop(
      "checked",
      item.hintShow
    );
  ...
  rangeDialog: function (dataSource, txt) {
    ...
    let scrollLeft = $(document).scrollLeft(),
      scrollTop = $(document).scrollTop();
    $("#luckysheet-dataVerificationRange-dialog")
      .css({
        left: (winw + scrollLeft - myw) / 2,
        top: (winh + scrollTop - myh) / 3,
      })
  ...
  cellFocus: function (r, c, clickMode) {
    ...
    if (item.type == "dropdown") {
      ...
      if ($("#luckysheet-dataVerification-dropdown-List").is(":visible")) {
        let dataIndex = $("#luckysheet-dataVerification-dropdown-List").prop(
          "data-index"
        );
    ...
    if (hintText.length == 0) {
      if (Store.lang == "en") {
        if (item.type == "dropdown") {
          ...
          hintText +=
            "please enter a " +
            _this.optionLabel_en[item.type] +
            " " +
            _this.optionLabel_en[item.type2] +
            " " +
            item.value1;
          ...
          hintText +=
            "please enter the correct " + _this.optionLabel_en[item.type2];
        }
      } else {
        if (item.type == "dropdown") {
          ...
          hintText +=
            "请输入内容" +
            _this.optionLabel[item.type2] +
            item.value1 +
            "的文本";
        } else if (item.type == "text_length") {
          hintText +=
            "请输入长度" + _this.optionLabel[item.type2] + item.value1;
  ...
  getFailureText: function (item) {
    ...
    if (Store.lang == "en") {
      if (item.type == "dropdown") {
        ...
        failureText +=
          "what you entered is not text that " +
          _this.optionLabel_en[item.type2] +
          " " +
          item.value1;
      } else if (item.type == "text_length") {
        ...
        failureText +=
          "what you entered is not a correct " +
          _this.optionLabel_en[item.type2];
      }
    } else {
      if (item.type == "dropdown") {
        ...
        failureText +=
          "你输入的不是" + _this.optionLabel[item.type2] + item.value1;
  ...
  dropdownListShow: function () {
    ...
    if (item.type === "dropdown" && item.type2) {
      ...
      list.forEach(i => {
        ...
        optionHtml += `<div class="dropdown-List-item  luckysheet-mousedown-cancel multi${
          checked ? " checked" : ""
        }">${i}</div>`;
      });
    } else {
  ...
  ref: function (historyDataVerification, currentDataVerification, sheetIndex) {
    ...
    Store.luckysheetfile[getSheetIndex(sheetIndex)].dataVerification =
      currentDataVerification;

    //共享编辑模式
    if (server.allowUpdate) {
      server.saveParam("all", sheetIndex, currentDataVerification, {
        k: "dataVerification",
      });
    }
