...
const luckysheetDropCell = {
  iconHtml:
    '<div id="luckysheet-dropCell-icon" style="position: absolute;padding: 2px;background-color: #f1f1f1;z-index: 990;cursor: pointer;">' +
    '<div id="icon_dropCell"></div>' +
    "</div>",
  typeListHtml:
    '<div id="luckysheet-dropCell-typeList" class="luckysheet-cols-menu luckysheet-rightgclick-menu luckysheet-mousedown-cancel">' +
    ...
    $("#luckysheet-dropCell-icon")
      ...
      .mousedown(function (event) {
        ...
        $(
          ...
          .find("span")
          .append('<i class="fa fa-check luckysheet-mousedown-cancel"></i>');
