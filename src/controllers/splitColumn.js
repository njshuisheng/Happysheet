...
const luckysheetSplitColumn = {
  createDialog: function () {
    ...
    $("body.object-design").append(
      replaceHtml(modelHTML, {
        ...
        content: content,
        botton:
          '<button id="luckysheet-splitColumn-dialog-confirm" class="btn btn-primary">' +
  ...
  init: function () {
    ...
    $(document)
      .off("keyup.SPCinptext")
      .on(
        "keyup.SPCinptext",
        "#luckysheet-splitColumn-dialog .box input[type='text']",
        function () {
    ...
    //确定按钮
    $(document)
      .off("click.SPCconfirm")
      .on(
        "click.SPCconfirm",
        "#luckysheet-splitColumn-dialog #luckysheet-splitColumn-dialog-confirm",
        function () {
  ...
  update: function (r, c, dataArr) {
    ...
    let range = [
      {
        row: [st_r, st_r + dataArr.length - 1],
        column: [st_c, st_c + dataArr[0].length - 1],
      },
    ];
  ...
  getRegStr: function () {
    ...
    $(
      "#luckysheet-splitColumn-dialog .box input[type='checkbox']:checked"
    ).each(function (i, e) {
      let $id = $(e).attr("id");
